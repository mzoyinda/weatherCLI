...
const current = "temperature_2m,relative_humidity_2m,apparent_temperature,is_day,precipitation,rain,showers,snowfall&temperature_unit=celsius&windspeed_unit=mph&precipitation_unit=inch&timeformat=unixtime";
...
function getWeather(location) {
  return axios
    ...
    .then(({ data }) => {
      ...
      const time = new Date(current.time * 1000).toLocaleTimeString({
		hour: 'numeric',
		minute: '2-digit',
		hour12: true
	});
